...
export default function ContactForm({
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus("error");
      setServerError("Network error. Please try again or email contact@oregonsmbdirectory.com directly.");
    }
  };
    ...
    return (
      <div className="rounded-xl border border-primary/30 bg-primary/5 p-8 text-center">
        ...
        <p className="text-muted-foreground">
          ...
          <a className="text-primary underline" href="mailto:contact@oregonsmbdirectory.com">
